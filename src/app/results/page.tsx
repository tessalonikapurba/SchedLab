...
export default function ResultsPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'recommendation' | 'metrics' | 'formulas' | 'analysis'
  >('recommendation');
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] bg-surface text-foreground py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-6">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-accent/15 text-accent border border-accent/30">
                ...
                {selectedAlgorithm === 'MLFQ' &&
                  ` (q0=${timeQuantum}, q1=${timeQuantum * 2})`}
            ...
            <p className="text-sm text-muted mt-1">
              Performance metrics, schedule timeline, and workload analysis.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-foreground bg-surface-alt border border-border rounded-lg hover:bg-surface transition-colors"
            >
              <RotateCcw size={14} />
              Replay Live
            </button>
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-1 w-32 bg-surface border border-border rounded-md shadow-lg hidden group-hover:block z-10 py-1">
                <button
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-xl bg-surface-alt border border-border">
              ...
              <p className="text-[11px] text-muted mt-1">
                CPU process-to-process handoffs
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-surface-alt border border-border">
              ...
              <div className="text-2xl font-bold font-mono text-foreground flex items-baseline gap-2">
                ...
                <span
                  className={`text-[10px] font-sans font-semibold px-1.5 py-0.5 rounded ${metrics.fairnessIndex >= 0.9
              ...
              <p className="text-[11px] text-muted mt-1">
                1.000 = perfectly balanced service
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-surface-alt border border-border">
              ...
              <p className="text-[11px] text-muted mt-1">
                Arrival to first execution start
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-surface-alt border border-border">
              ...
              <div className="text-xl font-bold font-mono text-foreground mt-0.5">
                <span
                  className={`inline-block px-2 py-0.5 rounded text-sm font-semibold ${metrics.starvationRisk === 'None'
              ...
              <p className="text-[11px] text-muted mt-1">
                Waiting skew &amp; starvation exposure
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-surface-alt border border-border">
              ...
              <p className="text-[11px] text-muted mt-1">
                Time-average Ready Queue length
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Gantt Chart */}
        <section className="p-5 rounded-xl bg-surface-alt border border-border space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono text-muted">
              Total Duration: {results.totalTime} units
            </span>
          </div>
            ...
            <div className="min-w-[600px]">
              ...
              <div className="flex h-12 w-full rounded-lg overflow-hidden border border-border">
                {gantt.map((seg, idx) => {
                  ...
                  const pct =
                    (duration / (results.totalTime || 1)) * 100;
                  ...
                  return (
                    <div
                      key={idx}
                      style={{ width: `${pct}%` }}
                      className={`h-full flex flex-col items-center justify-center text-xs font-mono font-bold transition-all relative border-r border-background/20 last:border-0 ${isIdle
        ...
        <section className="p-5 rounded-xl bg-surface-alt border border-border space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-muted">
              {procResults.length} processes evaluated
            </span>
          </div>
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="border-b border-border bg-surface text-muted">
                  ...
                  <th className="py-2.5 px-3 font-semibold font-mono text-blue-400">
                    Turnaround (TAT)
                  </th>

                  <th className="py-2.5 px-3 font-semibold font-mono text-amber-400">
                    Waiting (WT)
                  </th>

                  <th className="py-2.5 px-3 font-semibold font-mono text-emerald-400">
                    Response (RT)
                  </th>
                </tr>
              </thead>
              ...
              <tbody className="divide-y divide-border">
                {procResults.map((p) => (
                  ...
                  >
                    <td className="py-2.5 px-3 font-semibold font-mono text-accent">
                      {p.pid}
                    </td>
              ...
              <tfoot>
                <tr className="border-t-2 border-border bg-surface font-semibold">
                  <td
                    colSpan={6}
                    className="py-2.5 px-3 text-right text-muted"
                  >
                    Workload Average:
                  </td>
        ...
        <section className="p-6 rounded-xl bg-surface-alt border border-border space-y-5">
          <div className="flex overflow-x-auto border-b border-border gap-4">
            <button
              onClick={() => setActiveTab('recommendation')}
              className={`pb-2.5 text-xs font-medium border-b-2 transition-colors flex items-center gap-1.5 whitespace-nowrap ${activeTab === 'recommendation'
            ...
            <button
              ...
              className={`pb-2.5 text-xs font-medium border-b-2 transition-colors whitespace-nowrap ${activeTab === 'metrics'
                ? 'border-accent text-accent font-bold'
                : 'border-transparent text-muted hover:text-foreground'
                }`}
            >
            ...
            <button
              ...
              className={`pb-2.5 text-xs font-medium border-b-2 transition-colors whitespace-nowrap ${activeTab === 'formulas'
                ? 'border-accent text-accent font-bold'
                : 'border-transparent text-muted hover:text-foreground'
                }`}
            >
            ...
            <button
              ...
              className={`pb-2.5 text-xs font-medium border-b-2 transition-colors whitespace-nowrap ${activeTab === 'analysis'
                ? 'border-accent text-accent font-bold'
                : 'border-transparent text-muted hover:text-foreground'
                }`}
            >
          ...
          {activeTab === 'recommendation' && (
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-surface border border-accent/40 space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-border/60 pb-3">
                  ...
                  {recommendation.primaryAlgorithm !== selectedAlgorithm ? (
                    <button
                      onClick={() =>
                        handleApplyRecommendation(
                          recommendation.primaryAlgorithm
                        )
                      }
                    ...
                    <span className="flex items-center gap-1 text-xs font-semibold text-emerald-400 bg-emerald-500/10 px-2.5 py-1 rounded-md border border-emerald-500/20 shrink-0">
                      <CheckCircle2 size={13} />
                      Current algorithm matches the recommendation
                    </span>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                  ...
                  <div className="p-2.5 rounded-lg bg-surface-alt border border-border">
                    <div className="flex justify-between text-[11px] mb-1">
                      <span className="font-semibold text-muted">
                        Latency / Wait Optimization
                      </span>

                      <span className="font-mono font-bold text-foreground">
                        {recommendation.suitabilityScore.latency}%
                      </span>
                    </div>
                    ...
                    <div className="h-1.5 rounded-full bg-border overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${recommendation.suitabilityScore.latency}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="p-2.5 rounded-lg bg-surface-alt border border-border">
                    <div className="flex justify-between text-[11px] mb-1">
                      ...
                      <span className="font-mono font-bold text-foreground">
                        {recommendation.suitabilityScore.fairness}%
                      </span>
                    </div>
                    ...
                    <div className="h-1.5 rounded-full bg-border overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${recommendation.suitabilityScore.fairness}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="p-2.5 rounded-lg bg-surface-alt border border-border">
                    <div className="flex justify-between text-[11px] mb-1">
                      ...
                      <span className="font-mono font-bold text-foreground">
                        {recommendation.suitabilityScore.overhead}%
                      </span>
                    </div>
                    ...
                    <div className="h-1.5 rounded-full bg-border overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${recommendation.suitabilityScore.overhead}%`,
                        }}
                      />
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  <div className="space-y-1.5">
                    <h4 className="text-xs font-bold text-foreground flex items-center gap-1.5">
                      ...
                      {recommendation.primaryAlgorithmName}
                    </h4>
                      ...
                      {recommendation.alternativeOptions.map((alt) => (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              onClick={() =>
                                handleApplyRecommendation(alt.algorithm)
                              }
          ...
          {activeTab === 'metrics' && (
            <div className="space-y-4 text-xs text-muted leading-relaxed">
              <div className="p-3.5 rounded-lg bg-surface border border-border">
                ...
                <p>
                  With <strong>{selectedAlgorithm}</strong>, processes
                  completed across a total span of{' '}
                  <strong className="text-foreground">
                    {results.totalTime} units
                  </strong>
                  . The CPU experienced{' '}
                  <strong className="text-foreground">
                    {metrics.contextSwitches} context switches
                  </strong>
                  , while achieving a Jain&apos;s fairness index of{' '}
                  <strong className="text-foreground">
                    {metrics.fairnessIndex.toFixed(3)}
                  </strong>{' '}
                  and an average ready queue length of{' '}
                  <strong className="text-foreground">
                    {metrics.avgQueueLength.toFixed(2)} processes
                  </strong>
                  .
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              ...
              <div className="p-4 rounded-lg bg-surface border border-border space-y-2">
                ...
                <p className="text-muted">
                  Total elapsed time spent by the process from initial
                  arrival into the system until final termination.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-surface border border-border space-y-2">
                ...
                <p className="text-muted">
                  Cumulative duration spent by the process waiting
              ...
              <div className="p-4 rounded-lg bg-surface border border-border space-y-2">
                ...
                <div className="p-2.5 rounded bg-surface-alt font-mono text-emerald-400 text-xs">
                  J = (∑ xᵢ)² / (n · ∑ xᵢ²), &nbsp; where xᵢ = Burst / TAT
                </div>

                <p className="text-muted">
                  Measures how evenly service is distributed across
                  processes. The index is bounded by [1/n, 1.0].
                </p>
              </div>

              <div className="p-4 rounded-lg bg-surface border border-border space-y-2">
                <h4 className="font-semibold text-foreground">
                  Average Ready Queue Length (Lq)
                </h4>

                <div className="p-2.5 rounded bg-surface-alt font-mono text-indigo-400 text-sm">
                  Lq = (∑ Waiting Time) / Schedule Length
                </div>

                <p className="text-muted">
                  Represents the time-average number of processes
              ...
              <div className="p-4 rounded-lg bg-surface border border-border space-y-2">
                ...
                <div className="p-2.5 rounded bg-surface-alt font-mono text-purple-400 text-xs">
                  Switch = Process_B.start where Process_B ≠ Process_A
                </div>

                <p className="text-muted">
                  Preemption and quantum expiration can require a
              ...
              <div className="p-4 rounded-lg bg-surface border border-border space-y-2">
                ...
                <p className="text-muted">
                  Ratio of CPU busy time to total schedule duration.
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'analysis' && (
            <div className="space-y-4 text-xs text-muted leading-relaxed">
              <p>
                CPU scheduling involves trade-offs between{' '}
                <strong>latency</strong>, <strong>throughput</strong>,
                and <strong>fairness</strong>. Preemptive algorithms
                such as SRTF, Round Robin, and MLFQ can improve
                responsiveness while increasing the number of scheduling
                decisions and potential context switches.
              </p>

              <div className="p-4 rounded-lg bg-surface border border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  <h4 className="font-semibold text-foreground">
                    Benchmark all 7 algorithms on this workload
                  </h4>

                  <p className="text-muted mt-0.5">
                    Compare FCFS, SJF, SRTF, Priority, Round Robin,
                    MLFQ, and Priority with Aging side-by-side.
                  </p>
                </div>
