...
export const ALGORITHMS: AlgorithmInfo[] = [
  {
    ...
    shortName: 'FCFS',
    description: 'Runs processes in arrival order.',
    preemptive: false,
  },
  {
    type: 'SJF',
    ...
    shortName: 'SJF',
    description: 'Runs the process with the shortest CPU burst.',
    preemptive: false,
  },
  {
    type: 'SRTF',
    ...
    shortName: 'SRTF',
    description: 'Preemptive SJF. Runs the process with the shortest remaining time.',
    preemptive: true,
  },
  {
    type: 'PRIORITY',
    ...
    shortName: 'Priority',
    description: 'Runs the highest-priority process first.',
    preemptive: false,
  },
  {
    type: 'RR',
    name: 'Round Robin',
    shortName: 'RR',
    description: 'Runs each process for a fixed time quantum.',
    preemptive: true,
  },
  {
    type: 'MLFQ',
